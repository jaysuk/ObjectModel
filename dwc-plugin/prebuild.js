 ...
 * Reads local ObjectModel TypeScript sources + fetches DSF C# XML docs from GitHub,
 * runs the same parse logic as the standalone viewer, and writes the result as
 * dwc-plugin/src/model-data.js for bundling into the plugin at build time.
 */
...
const OM_SRC_DIR = path.resolve(__dirname, '../src');
